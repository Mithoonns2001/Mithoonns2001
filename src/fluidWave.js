...
if (canvas) {
    ...
    function getWebGLContext(e) {
        ...
        o = r.getExtension("OES_texture_float_linear")) : (i = r.getExtension("OES_texture_half_float"),
        o = r.getExtension("OES_texture_half_float_linear")),
        r.clearColor(0, 0, 0, 1);
        const a = t ? r.HALF_FLOAT : i.HALF_FLOAT_OES;
        let u, v, l;
        return t ? (u = getSupportedFormat(r, r.RGBA16F, r.RGBA, a),
    ...
    function input() {
        ...
        for (let e = 0; e < n.length; e++) {
            const r = n[e];
            r.moved && (splat(r.x, r.y, r.dx, r.dy, r.color),
            r.moved = !1)
        }
    ...
    function step(n) {
        ...
        i.supportLinearFiltering || t.uniform2f(N.uniforms.dyeTexelSize, 1 / E, 1 / S),
        ...
        _.swap(),
        t.viewport(0, 0, D, y),
        i.supportLinearFiltering || t.uniform2f(N.uniforms.dyeTexelSize, 1 / D, 1 / y),
        t.uniform1i(N.uniforms.uVelocity, _.read.texId),
    ...
    function render(n) {
        null != n && e.TRANSPARENT ? t.disable(t.BLEND) : (t.blendFunc(t.ONE, t.ONE_MINUS_SRC_ALPHA),
        t.enable(t.BLEND));
        let r = null == n ? t.drawingBufferWidth : D
          , i = null == n ? t.drawingBufferHeight : y;
        if (t.viewport(0, 0, r, i),
        !e.TRANSPARENT) {
            w.bind();
            let r = e.BACK_COLOR;
        ...
        t.uniform1i(B.uniforms.uTexture, A.read.texId)) : (I.bind(),
        t.uniform1i(I.uniforms.uTexture, A.read.texId)),
        x(n)
    }
    ...
    canvas.addEventListener("mousemove", e=>{
        splat(e.offsetX, e.offsetY, 5 * (e.offsetX - my_dx), 5 * (e.offsetY - my_dy), my_color),
        my_dx = e.offsetX,
        my_dy = e.offsetY
    }
    ),
